...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/features/channel-management" element={<ChannelManagement />} />
      <Route path="/features/digital-rights" element={<DigitalRights />} />
      <Route path="/features/global-distribution" element={<GlobalDistribution />} />
      <Route path="/features/boutique-monetization" element={<BoutiqueMonetization />} />
      <Route path="/" element={<HomePage />} />
      <Route path="/purple" element={<AdminPanel />} />
